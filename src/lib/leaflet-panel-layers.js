...
(function() {
        ...
        L.Control.PanelLayers = L.Control.Layers.extend({
                ...
                _addItem: function(obj) {
                    ...
                    if (obj.group) {
                        ...
                        if (!this._groups[obj.group.name]) {
                            ...
                            console.log("-- Groud already exist");
                            console.log(this._groups[obj.group.name]);
                            console.log(this._groups[obj.group.name].getElementsByTagName("input"))
                        }
                ...
                _createGroup: function(groupdata, ismap) {
                    ...
                    // if (ismap === false) {
                    //     grouplabel_text.innerHTML = groupdata.name + ' - Select all animals';
                    //     L.DomEvent.on(grouplabel, 'click', function() {
                    //         var checkboxes = document.getElementsByName('map-input-' + groupdata.name);
                    //         var toCheck = false;
                    //         if (group.dataset.checked == 'false') {
                    //             toCheck = true;
                    //             group.dataset.checked = true;
                    //             grouplabel_text.innerHTML = groupdata.name + ' - Unselect all animals';
                    //         } else {
                    //             group.dataset.checked = false;
                    //             grouplabel_text.innerHTML = groupdata.name + ' - Select all animals';
                    //         }
